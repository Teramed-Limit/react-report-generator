...
import { formDefineAtom, imageDefineAtom } from '../recoil/atoms/report-generator-atoms.ts';
import { FormDefine } from '../types/define.ts';
...
import FieldAttributeEditor from './ReportDefine/Attribute/FieldAttributeEditor/FieldAttributeEditor.tsx';
...
interface Props {
	...
	imageDefine: FormDefine;
	headerDefine: RepPage;
	footerDefine: RepPage;
	codeList: Record<string, any[]>;
}

const ISVReportGenerator = forwardRef<ISVReportGeneratorHandle, Props>(
					...
					<Stack direction="column" spacing="4px">
						...
						<Box className={classes.reportLayout} sx={reportPage}>
							<Box className={classes.page}>
								...
								{/* Image */}
								{/* <ReportGeneratorImagePage showGuideLine={showGuideLine} fields={imageDefine} /> */}
							</Box>
						</Box>
					</Stack>
					<ReportPropertyPanel />
...
export default withRecoilRoot(ISVReportGenerator);
