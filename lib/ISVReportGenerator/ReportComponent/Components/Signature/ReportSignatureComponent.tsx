...
const ReportSignatureComponent = React.forwardRef<HTMLImageElement, ReportComponentProps<RepImageComponent>>(
	(
		{
			style,
			scale,
...
ReportSignatureComponent.displayName = 'ReportSignatureComponent';
