...
function FieldCompositeContainer({ id, field: compositeField, appendValueChangedId, prefixComp, suffixComp }: Props) {
	...
	// const [compositeValue, setCompositeValue] = useRecoilState(compositeValueAtom(compositeField));
	// const compositeState = useRecoilValue(compositeStateAtom(compositeField));
	//= [
	// const onValueChange = (text: any) => {
	// 	setCompositeValue(text);
	// };
