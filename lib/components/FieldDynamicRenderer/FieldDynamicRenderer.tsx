...
function FieldDynamicRenderer({ field, fieldMapper, value, modifiable, onValueChange }: Props) {
	...
	return (
		<>
			<RenderComponent disabled={!modifiable} field={field} value={value} onValueChange={onValueChange} />
		</>
	);
}
